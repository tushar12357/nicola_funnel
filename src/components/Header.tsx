  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-30">
        <div className="absolute inset-0 -top-1/2 -left-1/2 w-[200%] h-[200%] bg-[radial-gradient(circle,rgba(0,102,255,0.05)_1px,transparent_1px)] bg-[length:30px_30px] animate-[headerDrift_25s_linear_infinite]"></div>
      </div>
      {/* Floating Particles */}
      {[...Array(5)].map((_, i) => (
        <div
      ...
      <div className="relative z-[2000] max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex items-center justify-between py-4 sm:py-6 lg:py-8 gap-4 header-content">
          ...
          <div className="flex items-center gap-3 animate-[logoSlideIn_0.8s_ease-out]">
            <img
              ...
              loading="eager"
            />
            <div className="text-lg sm:text-xl lg:text-2xl font-black bg-gradient-to-br from-[#0066ff] via-[#00ccff] via-[#00ff88] via-[#ffd93d] to-[#ff6b6b] bg-clip-text text-transparent bg-[length:200%_auto] animate-[logoShimmer_3s_linear_infinite]">
              BestCallerAI
            </div>
          </div>
          ...
          <div className="hidden lg:flex items-center gap-3 animate-[buttonsSlideIn_0.8s_ease-out_0.2s_backwards]">
            ...
            >
              ...
              Book a Free Demo
              <span
                className="absolute inset-[-2px] rounded-full bg-gradient-to-br from-[#0066ff] via-[#00ccff] via-[#00ff88] via-[#ffd93d] to-[#ff6b6b] opacity-0 transition-opacity duration-300 group-hover:opacity-100"
                style={{
          ...
          {/* Mobile Menu Toggle */}
          <button
            className={`lg:hidden flex flex-col gap-1.5 p-2 rounded-lg hover:bg-white/10 transition-all duration-300 mobile-menu-toggle ${
          ...
          >
            <div
              className={`w-6 h-0.5 bg-gradient-to-br from-[#0066ff] to-[#00ccff] rounded transition-all duration-300 ${
                isMobileMenuOpen
        ...
        <div
          ref={mobileMenuRef}
          id="mobileMenu"
          className={`lg:hidden fixed top-[68px] left-0 w-full bg-gradient-to-br from-black/95 via-[#001a33]/95 to-[#003366]/95 backdrop-blur-lg border-t border-white/10 py-8 px-4 transition-all duration-300 ease-in-out z-[3000] ${
            isMobileMenuOpen
        ...
        >
          ...
          <div className="flex flex-col gap-4 items-center max-w-md mx-auto">
            ...
            >
              ...
              Book a Free Demo
              <span
                className="absolute inset-[-2px] rounded-full bg-gradient-to-br from-[#0066ff] via-[#00ccff] to-[#ff6b6b] opacity-0 transition-opacity duration-300 group-hover:opacity-100"
                style={{
                  mask: "linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)",
                  WebkitMaskComposite: "xor",
                }}
