...
const solutionsData = [
  {
    useCase: { title: '📞 Customer Service', description: '24/7 support and assistance' },
    industry: { title: 'Any Industry', description: 'Universal application' },
  },
  {
    useCase: { title: '🏥 Receptionist', description: 'Professional front desk services' },
    industry: { title: 'Medical Clinics, Hotels, Corporations', description: 'Professional service environments' },
  },
  {
    useCase: { title: '💼 Sales Agents', description: 'Intelligent sales automation' },
    industry: { title: 'Real Estate, Insurance, Financial Services, Agencies, Solar', description: 'High-value sales industries' },
  },
  {
    useCase: { title: '📱 Call Center', description: 'Scalable call operations' },
    industry: { title: 'Cold Outreach, Inbound and Outbound Calls', description: 'All call center operations' },
  },
  {
    useCase: { title: '🛎️ Concierge', description: 'Premium guest services' },
    industry: { title: 'Hotels, Personalized Services', description: 'Luxury hospitality and personalized client care' },
  },
  {
    useCase: { title: '📊 Data Collection', description: 'Intelligent data gathering' },
    industry: { title: 'Research, Lead Generation', description: 'Data-driven industries' },
  },
  {
    useCase: { title: '🎯 Lead Qualification & Reactivation', description: 'Smart lead management' },
    industry: { title: 'Sales, Client Acquisition', description: 'Growth-focused businesses' },
  },
  {
    useCase: { title: '📋 Booking Scheduling, Confirmation & Reminders', description: 'Complete booking management' },
    industry: { title: 'Any Industry', description: 'Universal application' },
  },
  {
    useCase: { title: '🌐 Omni-Channel Sales & Marketing', description: 'Multi-platform engagement' },
    industry: { title: 'Any Industry', description: 'Universal application' },
  },
  {
    useCase: { title: '🌍 Multilingual Geographic Expansion', description: 'Global market reach' },
    industry: { title: 'International Clients', description: 'Global businesses' },
  },
];

const galleryImages = [
  { src: 'https://storage.googleapis.com/msgsndr/PwZCE4paYkzqicpqJecc/media/68937c1665ff1546fff11a4d.png', alt: 'AI Solution 1' },
  { src: 'https://storage.googleapis.com/msgsndr/PwZCE4paYkzqicpqJecc/media/68937c1a0291e86f83ee441a.png', alt: 'AI Solution 2' },
  { src: 'https://storage.googleapis.com/msgsndr/PwZCE4paYkzqicpqJecc/media/68937c1df8ddde1b2e0f5aad.png', alt: 'AI Solution 3' },
];
        ...
        {[...Array(6)].map((_, i) => (
          <div
            ...
            style={{
              ...
              animation: `particleFloat ${[15, 20, 18, 22, 16, 19][i]}s infinite ease-in-out`,
      ...
      <div className="max-w-7xl mx-auto relative z-10 w-full">
        ...
        <div className="text-center mb-20 animate-fadeInDown">
          <div className="inline-flex items-center gap-2.5 bg-[rgba(0,102,255,0.1)] backdrop-blur-md border border-[rgba(0,102,255,0.2)] rounded-full px-7 py-3 mb-7 relative overflow-hidden">
            ...
            <div className="w-6 h-6 bg-gradient-to-br from-[#0066ff] to-[#00ccff] rounded-full flex items-center justify-center text-white font-bold text-sm animate-iconPulse">✓</div>
            <span className="text-[#00ccff] text-sm font-semibold uppercase tracking-widest">Perfect Solutions</span>
          </div>
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-white mb-6">
            Our Solutions Are <span className="bg-gradient-to-r from-[#0066ff] via-[#00ccff] to-[#00ff88] bg-clip-text text-transparent bg-[length:200%_auto] animate-textShimmer">Perfect For</span>
          </h2>
          <p className="text-lg md:text-2xl text-[rgba(255,255,255,0.7)] font-normal max-w-2xl mx-auto leading-relaxed">
            Discover how our AI-powered solutions can transform your business across various use cases and industries
          </p>
        </div>
          ...
          <table className="w-full border-collapse bg-transparent">
            <thead>
              <tr>
                <th className="bg-gradient-to-br from-[#001a33] to-[#002244] text-white text-xl font-bold py-6 px-8 text-left rounded-tl-2xl">
                  <span className="inline-block mr-3 text-2xl animate-headerIconBounce">🎯</span>
                  Use Cases
                </th>
            ...
            <tbody>
              {solutionsData.map((item, index) => (
                <tr
                  key={index}
                  className={`transition-all duration-300 ${index % 2 === 0 ? 'bg-[rgba(255,255,255,0.02)]' : 'bg-[rgba(0,102,255,0.02)]'} hover:bg-[rgba(0,102,255,0.08)] hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(0,102,255,0.15)] ${index === solutionsData.length - 1 ? 'last:[&>td:first-child]:rounded-bl-2xl last:[&>td:last-child]:rounded-br-2xl' : ''}`}
                >
                  <td className="py-5 px-8 align-top border-r border-[rgba(255,255,255,0.05)] last:border-r-0">
                    <div className="flex items-start gap-4">
                      <span className="text-lg flex-shrink-0 mt-0.5 drop-shadow-[0_0_8px_rgba(0,255,136,0.6)] animate-checkPulse">✅</span>
                      <div className="flex flex-col gap-1.5">
                        <span className="text-white text-base font-semibold flex items-center gap-2">{item.useCase.title}</span>
                        <span className="text-[rgba(255,255,255,0.6)] text-sm font-normal">{item.useCase.description}</span>
                      </div>
                    </div>
                  </td>
                  <td className="py-5 px-8 align-top border-r border-[rgba(255,255,255,0.05)] last:border-r-0">
                    <div className="flex items-start gap-4">
                      <span className="text-lg flex-shrink-0 mt-0.5 drop-shadow-[0_0_8px_rgba(0,255,136,0.6)] animate-checkPulse">✅</span>
                      <div className="flex flex-col gap-1.5">
                        <span className="text-white text-base font-semibold flex items-center gap-2">{item.industry.title}</span>
                        <span className="text-[rgba(255,255,255,0.6)] text-sm font-normal">{item.industry.description}</span>
                      </div>
                    </div>
                  </td>
                </tr>
        ...
        <div className="relative my-20 py-16">
          ...
          <div className="flex justify-center items-center gap-12 flex-wrap relative z-[2]">
            {galleryImages.map((image, index) => (
              ...
              >
                <div className="relative w-[450px] h-[320px] rounded-3xl overflow-hidden bg-gradient-to-br from-[#001a33] to-[#002244] p-2 shadow-[0_10px_30px_rgba(0,0,0,0.3),0_0_0_2px_rgba(0,255,136,0.3),inset_0_0_0_1px_rgba(0,255,136,0.1)] group-hover:shadow-[0_25px_50px_rgba(0,0,0,0.4),0_0_0_3px_rgba(0,255,136,0.6),0_0_30px_rgba(0,255,136,0.4),inset_0_0_0_1px_rgba(0,255,136,0.2)]">
                  <img
                    src={image.src}
                    alt={image.alt}
                    className="w-full h-full object-cover rounded-xl transition-all duration-300 group-hover:scale-105 group-hover:brightness-110 group-hover:contrast-110 relative z-[1]"
                  />
        ...
        <div className="text-center animate-ctaFadeIn">
          ...
          >
            <a  href="https://calendly.com/bestcallerai-support/30min?back=1&month=2025-09" target='_blank' className="relative z-10 transition-all duration-300">Get Instant Access Now</a>
            <span className="relative z-10 text-xl font-bold transition-transform duration-300 group-hover:translate-x-2 group-hover:scale-110">→</span>
