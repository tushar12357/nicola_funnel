...
const Pricing = () => {
  ...
  const plans = [
    {
      ...
      allDoneDesc:
        "includes Starter Plan features + setup of system and campaigns, software, integration, testing, management, optimization, new features",
      features: [
    ...
    },
    {
      ...
      allDoneDesc:
        "includes Pro Plan features + setup of system and campaigns, software, integration, testing, management, optimization, new features",
      features: [
        "10 AI Voice Agents",
    ...
    },
    {
      ...
      allDoneDesc:
        "includes Enterprise solution + setup of system and campaigns, software, omni-channel integration, testing, management, optimization, new features",
      features: [
  ...
  return (
    <section
      id="custom-code-hyHEAdqwag"
      data-ghl-element-id="hyHEAdqwag"
      className="relative w-full bg-gradient-to-b from-black via-[#001a33] to-black py-24 overflow-hidden"
    >
      {/* Background Effects */}
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute w-[500px] h-[500px] bg-gradient-to-br from-[#0066ff] to-[#00ff88] rounded-full blur-[100px] opacity-40 animate-[orbDrift_20s_ease-in-out_infinite] -top-64 -left-64"></div>
        <div
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-6 lg:px-5">
        ...
        <header className="text-center mb-20 animate-[priceFadeIn_0.8s_ease-out]">
          <div className="inline-flex items-center gap-2.5 bg-gradient-to-br from-[#00ff88]/10 to-[#0066ff]/10 backdrop-blur-lg border border-[#00ff88]/20 rounded-full py-3 px-7 mb-7 relative overflow-hidden">
            ...
            <span className="text-xl animate-[pricePulse_2s_ease-in-out_infinite]">
              ✨
            </span>
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white mb-6">
            Choose your{" "}
            <span className="bg-gradient-to-br from-[#0066ff] via-[#00ff88] via-[#ffd93d] via-[#ff6b6b] to-[#0066ff] bg-clip-text text-transparent bg-[length:200%_auto] animate-[priceShimmer_3s_linear_infinite]">
              BestCallerAI
            </span>{" "}
            Plan
          </h1>
          <p className="text-lg sm:text-xl text-white/70 font-normal max-w-3xl mx-auto leading-relaxed">
            Select the perfect plan to supercharge your business with AI-powered
            voice agents.
          </p>
        </header>
        {/* Pricing Grid */}
        ...
        >
          {plans.map((plan, index) => (
            <div
              key={plan.name}
              className={`relative bg-white/5 backdrop-blur-lg border-2 border-transparent rounded-3xl p-10 sm:p-12 animate-[cardSlideIn_0.8s_ease-out_${
                0.3 + index * 0.1
              }s_backwards] hover:-translate-y-1 hover:scale-102 hover:shadow-[0_30px_60px_rgba(0,0,0,0.4)] transition-all duration-300 flex flex-col ${
                plan.className
